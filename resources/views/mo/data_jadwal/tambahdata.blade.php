@extends('/dashboard')
@section('container')
    <div class="d-flex align-items-center justify-content-center mt-4" style="width:90%; heigh:120%">
        <div class="card" style="width: 70%;">
            <div class="card-header-addPage py-4" style="background-color: #73D2F3">
                <h2 class="text-center">Tambah Data Jadwal</h2>
            </div>
            <div class="card-body" style="background-color: #9FE8FA">
                <div class="mt-3">
                    <form method="post" action="{{ url('/storeJadwal') }}">
                        @csrf
                        <div class="d-flex align-items-center justify-content-evenly">
                            <div class="mb-3 col-md-4">
                                ...
                                <input type="text" class="form-control @error('HARI_JADWAL_UMUM') is-invalid @enderror"
                                    name="HARI_JADWAL_UMUM" id="HARI_JADWAL_UMUM">
                            </div>
                            <div class="mb-3 col-md-4">
