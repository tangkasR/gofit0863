    ...
    <div class="d-flex align-items-center justify-content-center mt-4" style="width:90%; heigh:50%">
        <div class="card" style="width: 70%">
            <div class="card-header-addPage py-4" style="background-color: #73D2F3">
                <h2 class="text-center">Ubah Data Instruktur</h2>
            </div>
            <div class="card-body" style="background-color: #9FE8FA">
                <div class="">
                    <form method='post' action='{{ url('/editInstruktur/' . $instruktur->ID_INSTRUKTUR) }}'>
                        @csrf
                        @method('put')
                        <div class="d-flex align-items-center justify-content-evenly">
                            <div class="mb-3 col-md-4">
                                ...
                                <input style="width: 100%" type="text"
                                    ...
                                    name="NAMA_INSTRUKTUR" value="{{ $instruktur->NAMA_INSTRUKTUR }}">
                            </div>
                            <div class="mb-3 col-md-4">
                        ...
                        <div class="d-flex align-items-center justify-content-evenly">
                            ...
                            <div class="mb-3 col-md-4">
                                ...
                                <input style="width: 100%" type="text"
                                    ...
                                    name="UMUR_INSTRUKTUR" value="{{ $instruktur->UMUR_INSTRUKTUR }}">
                            </div>
                        </div>
                        <div class="d-flex align-items-center justify-content-evenly">
                            <div class="mb-3 col-md-4">
                                ...
                                <div class="input-group">
                                    <select class="form-select" id="JENIS_KELAMIN_INSTRUKTUR"
                                        ...
                                        <option value="{{ $instruktur->JENIS_KELAMIN_INSTRUKTUR }}" selected hidden>
                                            {{ $instruktur->JENIS_KELAMIN_INSTRUKTUR }}</option>
                        ...
                        <div class="card-footer text-muted p-4" style="background-color: #73D2F3">
                            <div class="d-flex align-items-center justify-content-center">
                                <a href="{{ url('/instruktur') }}" class="btn btn-dark">
                                    Batal
                                </a>
